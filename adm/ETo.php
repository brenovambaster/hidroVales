        ...
        <form action="ETo.php" method="GET">
            ...
            <div class=" form-row col-md-10 mx-auto">
                <div class="form-group col-md-4">
                    ...
                    <input type="number" class="form-control" required name="tempMin" id="tempMin">

                </div>
                <div class="form-group col-md-4">
                    <label for="tempMax">Temperatura máxima (C°):</label>
                    <input type="number" class="form-control" required name="tempMax" id="tempMax">
                </div>
                <div class=" form-group col-md-4">
                    <label for="lat">Latitude:</label>
                    <input type="float" name="lat" id="lat" required class="form-control">
                </div>
                <div class=" form-group col-md-4">
